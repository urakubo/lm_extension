...
hdf5write('CA1.h5','/dendrite',uint8(bw_Dend_crop),'/PSD',uint8(bw_PSD_crop),'/Mitochondrion',uint8(bw_Mito_crop),'/ER',uint8(bw_ER_crop),'/dendrite_and_PSD', uint8(bw_Dend_and_PSD),'/dendrite_not_PSD', uint8(bw_Dend_not_PSD));
