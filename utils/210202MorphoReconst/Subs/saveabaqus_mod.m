function [inode, ihedra] = saveabaqus_mod(node,face,elem,fname,heading)
%
...
%
% H.U modified this file on 170601. 
%
% 1. S3R => STRI3
% 2. Return the nodes and tetrahedra with their indices, as [inode, ihedra]
%
